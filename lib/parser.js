...
module.exports = (pattern = /^(#.+)|^(([A-Z][a-zA-Z0-9]+)(\s[a-z][a-zA-Z0-9]+)+\s+:\s+(.+))$|^(([A-Z][a-zA-Z0-9]+)\s+:\s+(.+))$|^(([a-z_][_a-zA-Z0-9]+)\s+\:\s+(.+))$|^(-{3,})$|^(([A-Z][a-zA-Z0-9]+)\.{3})$|^(([A-Z][a-zA-Z0-9]+))$/, functionParams = function(str){
